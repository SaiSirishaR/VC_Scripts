...
test_dir = '/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/pred' # the predicted files are stored here

if not os.path.exists(test_dir):
   os.makedirs(test_dir)

input_files = [filename for filename in sorted(os.listdir('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/input_full/'))]
output_files = [filename for filename in sorted(os.listdir('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/output_full/'))]
valid_input_files = [filename for filename in sorted(os.listdir('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/valid_input/'))]
valid_output_files = [filename for filename in sorted(os.listdir('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/valid_output/'))]
...
for i, (valid_input_file, valid_output_file) in enumerate(zip(valid_input_files, valid_output_files)):
      ...
      A = np.loadtxt('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/valid_input/' + valid_input_file)
      i_l = len(A)
...
for i, (input_file, output_file) in enumerate(zip(input_files, output_files)):
      A = np.loadtxt('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/input_full/' + input_file) 
      i_l = len(A) 
      B = np.loadtxt('/home3/srallaba/projects/siri_expts/merlin/egs/voice_conversion/s2/chinese/feats/output_full/' + output_file) 
      o_l = len(B)
